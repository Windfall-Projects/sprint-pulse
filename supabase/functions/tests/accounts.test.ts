...
const FUNCTIONS_URL = Deno.env.get("SUPABASE_URL") ? `${Deno.env.get("SUPABASE_URL")}/functions/v1` : (Deno.env.get("API_URL") ? `${Deno.env.get("API_URL")}/functions/v1` : "http://127.0.0.1:54321/functions/v1");
