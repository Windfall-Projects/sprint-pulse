...
import { CreateWorkItemSchema, UpdateWorkItemSchema, ListWorkItemsQuerySchema } from '@sprintpulse/shared/schemas/index.ts';
...
// ---------------------------------------------------------------------------
app.get('/', zValidator('query', ListWorkItemsQuerySchema), async (c) => {
