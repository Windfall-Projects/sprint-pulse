...
describe('7 · Surveys', () => {
    ...
    describe('SurveySchema', () => {
        ...
        it('accepts null team_id (system template)', () => {
            const s = { id: UUID, account_id: UUID, team_id: null, title: 'System', description: 'System template', trigger_event: 'sprint_end', is_system_template: true, created_at: ISO_TS };
            expect(SurveySchema.safeParse(s).success).toBe(true);
        });
    });
